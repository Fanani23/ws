	...
	return (
		<>
			<div className="bg-white p-5 rounded-lg flex flex-col flex-1 font-nunito-sans">
				...
				<div className="flex flex-row flex-wrap items-center mt-5 space-x-2">
					<button
						type="submit"
						className="h-10 px-2 bg-white border-2 border-black text-black hover:bg-black hover:text-white rounded-lg flex items-center"
					>
						Today
					</button>
					<input
				...
				<table className="mt-5 font-nunito-sans text-xs w-full overflow-y-scroll">
					...
					<tbody>
						<tr className="even:bg-[#F9F9FC]">
							...
							<td className="py-2">03-Feb-1990</td>
							<td className="py-2">Elis Tya Suitu</td>
