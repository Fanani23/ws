const DuoFilter = ({filterItem, setItem, menuItems}) => {
	return (
		<>
			<div className="flex">
				...
				<button className="bg-black text-white rounded-lg active:outline-none ml-3 my-2 px-3 py-2 font-noto-sans font-semibold">
					Men
				</button>
				<button className="bg-black text-white rounded-lg active:outline-none ml-3 my-2 px-3 py-2 font-noto-sans font-semibold">
					Product
