...
const SettingAdmin = () => {
  ...
  const [openAddSettingAdmin, setOpenAddSettingAdmin] = useState(false);

	const closeAddSettingAdminModal = () => {
		setOpenAddSettingAdmin(false);
	};

	const openAddSettingAdminModal = () => {
		setOpenAddSettingAdmin(true);
	};

  return (
    <div className="w-full flex flex-col grow overflow-ayto scrollbar-shown">
    <Transition appear show={openAddSettingAdmin} as={Fragment}>
      <Dialog
        as="div"
        className="relative z-10"
        onClose={closeAddSettingAdminModal}
      >
        <Transition.Child
          as={Fragment}
            ...
            >
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all">
                ...
                >
                  ...
                  <div 
                    onClick={closeAddSettingAdminModal}
    ...
    <div className="bg-white w-full p-5 rounded-lg overflow-hidden flex h-full flex-col">
      <div className="flex justify-between">
        ...
        <button
          ...
          onClick={openAddSettingAdminModal}
        >
